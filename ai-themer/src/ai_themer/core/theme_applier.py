...
class ThemeApplier:
    ...
    def _generate_swaync_css(self, palette: ColorPalette) -> str:
        """Generate SwayNC CSS compatible with GTK (no CSS custom properties)."""
        ...
        # Generate complete GTK-compatible CSS with all styling rules and direct color values
        css_content = []
        css_content.append("/* SwayNotificationCenter Theme */")
        css_content.append("/* Generated by AI Themer - GTK CSS Compatible */")
        css_content.append("")
        css_content.append("* {")
        css_content.append("  font-family: \"JetBrainsMono Nerd Font\", monospace;")
        css_content.append("  font-weight: normal;")
        css_content.append("  font-size: 14px;")
        css_content.append("}")
        css_content.append("")
        css_content.append("/* Notification window */")
        css_content.append(".notification-row {")
        css_content.append("  outline: none;")
        css_content.append("  margin: 10px;")
        css_content.append("  padding: 0;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-row:focus,")
        css_content.append(".notification-row:hover {")
        css_content.append(f"  background: {surface_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification {")
        css_content.append(f"  background: {bg_color};")
        css_content.append(f"  color: {text_color};")
        css_content.append("  border-radius: 8px;")
        css_content.append(f"  border: 1px solid {surface_color};")
        css_content.append("  padding: 0;")
        css_content.append("  margin: 0;")
        css_content.append("  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-content {")
        css_content.append("  background: transparent;")
        css_content.append("  padding: 15px;")
        css_content.append("  border-radius: 8px;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-default-action {")
        css_content.append(f"  background: {bg_color};")
        css_content.append(f"  color: {text_color};")
        css_content.append("  border-radius: 8px;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-default-action:hover {")
        css_content.append(f"  background: {surface_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".close-button {")
        css_content.append(f"  background: {error_color};")
        css_content.append(f"  color: {bg_color};")
        css_content.append("  text-shadow: none;")
        css_content.append("  padding: 4px;")
        css_content.append("  border-radius: 50%;")
        css_content.append("  margin-top: 10px;")
        css_content.append("  margin-right: 10px;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".close-button:hover {")
        css_content.append(f"  background: {error_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-action {")
        css_content.append(f"  background: {surface_color};")
        css_content.append(f"  color: {text_color};")
        css_content.append("  border-radius: 4px;")
        css_content.append(f"  border: 1px solid {surface_color};")
        css_content.append("  margin: 4px;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-action:hover {")
        css_content.append(f"  background: {surface_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-action:active {")
        css_content.append(f"  background: {accent_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".summary {")
        css_content.append("  font-size: 16px;")
        css_content.append("  font-weight: bold;")
        css_content.append(f"  color: {text_color};")
        css_content.append("  text-shadow: none;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".time {")
        css_content.append("  font-size: 12px;")
        css_content.append("  font-weight: normal;")
        css_content.append(f"  color: {text_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".body {")
        css_content.append("  font-size: 14px;")
        css_content.append("  font-weight: normal;")
        css_content.append(f"  color: {text_color};")
        css_content.append("  text-shadow: none;")
        ...
        css_content.append(f"  border: 1px solid {surface_color};")
        css_content.append("  border-radius: 8px;")
        css_content.append("  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.3);")
        css_content.append("  margin: 10px;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".control-center-list {")
        css_content.append("  background: transparent;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".control-center-list-placeholder {")
        css_content.append("  opacity: 0.5;")
        css_content.append("  font-size: 16px;")
        css_content.append(f"  color: {text_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".floating-notifications {")
        css_content.append("  background: transparent;")
        css_content.append("}")
        css_content.append("")
        css_content.append("/* Notification groups */")
        css_content.append(".notification-group {")
        css_content.append(f"  background: {bg_color};")
        css_content.append(f"  color: {text_color};")
        css_content.append("  border-radius: 8px;")
        css_content.append(f"  border: 1px solid {surface_color};")
        ...
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-group-headers {")
        css_content.append(f"  background: {surface_color};")
        css_content.append(f"  color: {text_color};")
        css_content.append("  border-radius: 8px 8px 0 0;")
        css_content.append("  padding: 10px;")
        css_content.append("  font-weight: bold;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-group-icon {")
        css_content.append(f"  color: {accent_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-group-close-all-button {")
        css_content.append(f"  background: {error_color};")
        css_content.append(f"  color: {bg_color};")
        css_content.append("  border-radius: 4px;")
        css_content.append("  border: none;")
        css_content.append("  padding: 4px 8px;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification-group-close-all-button:hover {")
        css_content.append(f"  background: {error_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append("/* Control center widgets */")
        ...
        css_content.append("}")
        css_content.append("")
        css_content.append(".widget-title > button {")
        css_content.append(f"  background: {accent_color};")
        css_content.append(f"  color: {bg_color};")
        css_content.append("  border: none;")
        css_content.append("  border-radius: 4px;")
        css_content.append("  padding: 8px 12px;")
        css_content.append("  font-weight: bold;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".widget-title > button:hover {")
        css_content.append(f"  background: {accent_color};")
        css_content.append("}")
        css_content.append("")
        ...
        css_content.append("}")
        css_content.append("")
        css_content.append(".widget-dnd > switch {")
        css_content.append(f"  background: {bg_color};")
        css_content.append(f"  border: 1px solid {surface_color};")
        css_content.append("  border-radius: 20px;")
        css_content.append("}")
        css_content.append("")
        ...
        css_content.append("}")
        css_content.append("")
        css_content.append(".widget-dnd > switch slider {")
        css_content.append(f"  background: {text_color};")
        css_content.append("  border-radius: 50%;")
        css_content.append("}")
        css_content.append("")
        css_content.append(".widget-inhibitors {")
        css_content.append(f"  background: {surface_color};")
        css_content.append(f"  color: {text_color};")
        css_content.append("  border-radius: 8px;")
        css_content.append("  padding: 15px;")
        ...
        css_content.append("}")
        css_content.append("")
        css_content.append(".widget-inhibitors > button {")
        css_content.append(f"  background: {accent_color};")
        css_content.append(f"  color: {bg_color};")
        css_content.append("  border: none;")
        css_content.append("  border-radius: 4px;")
        ...
        css_content.append("}")
        css_content.append("")
        css_content.append(".widget-inhibitors > button:hover {")
        css_content.append(f"  background: {accent_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append("/* Scrollbar styling */")
        css_content.append("scrollbar {")
        css_content.append("  background: transparent;")
        css_content.append("  width: 8px;")
        css_content.append("}")
        css_content.append("")
        css_content.append("scrollbar slider {")
        css_content.append(f"  background: {surface_color};")
        css_content.append("  border-radius: 8px;")
        css_content.append("}")
        css_content.append("")
        css_content.append("scrollbar slider:hover {")
        css_content.append(f"  background: {accent_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append("/* Urgency-specific styles */")
        css_content.append(".notification.low {")
        css_content.append(f"  border-color: {text_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification.normal {")
        css_content.append(f"  border-color: {accent_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification.critical {")
        css_content.append(f"  border-color: {error_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification.critical .summary {")
        css_content.append(f"  color: {error_color};")
        css_content.append("}")
        css_content.append("")
        css_content.append(".notification.critical .body {")
        css_content.append(f"  color: {error_color};")
        css_content.append("}")
        css_content.append("")
